...
import GameScores from '@/components/game_scores/GameScores';
  ...
  return (
    <div className="min-h-screen bg-dark-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="bg-[rgb(53,53,53)] p-8 rounded-lg shadow-lg mb-8">
        ...
        <div className="bg-[rgb(53,53,53)] p-8 rounded-lg shadow-lg">
